...
export default function DemoSentry() {
  ...
  return (
    <div>
      <Head>
        <title>sentry-example-error</title>
      ...
      <main>
        ...
        <h1>sentry-example-error</h1>

        <p className="description">
          Click the button below, and view the sample error on the Sentry{' '}
          <a target="_blank" rel="noopener" href="https://ethan-kennerly.sentry.io/issues/?project=4510727906066432">
            Issues Page
          </a>
